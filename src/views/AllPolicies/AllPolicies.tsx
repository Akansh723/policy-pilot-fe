  ...
  return (
    <>
      ...
      <header className={styles.header}>
        <button className={styles.backBtn} onClick={() => router.push('/')} aria-label="Go back to dashboard">
      ...
      <button className={styles.fab} onClick={() => router.push('/get-a-quote')} aria-label="Get a new quote">
